...
"		  Author:  sohunjug
"        Version:  1.3.0
"    Last_modify:  2017/04/21
"		  Github:  http://github.com/sohunjug
...
if has("win") || has("win32") || has("win32unix")
    let g:OS#name = "win"
    let g:OS#win = 1
    let g:OS#mac = 0
    let g:OS#unix = 0
...
elseif g:OS#unix
    ...
    let $BLOG = "/disk/Documents/blog"
endif
" 定义浏览器
if g:OS#win
    let s:browser = "D:/Applications/Firefox/firefox.exe"
elseif g:OS#unix
    let s:browser = "/usr/bin/chromuim"
endif
" }}}
...
" let g:session_default_name = 'workspace'
" let g:session_default_overwrite = 'yes'
" let g:session_autosave = 'yes'
" let g:session_autosave_silent = 'yes'
" let g:session_autosave_to = 'workspace'
" let g:xolox#session#ignore_window_patterns = [ 'unite', 'vimfiler', 'NERDTree' ]

" 切换c、c++、python工作目录
if g:OS#win
    let g:python_w = "D:/sohunjug-code/python"
    let g:cplus_w="D:/sohunjug-code/c"
    let g:k_w="D:/kayak/svn"
endif
if g:OS#unix
    let g:python_w = "/data/sohunjug-code/python"
    let g:cplus_w="/data/sohunjug-code/cpp"
    let g:sohunjug_w="/data/sohunjug-code"
    let g:k_w="/data/kayak/svn"
endif
...
map <Leader>ck :call ChangeWorkDir(g:k_w)<CR>:pwd<cr>
map <Leader>cd :call ChangeWorkDir(g:sohunjug_w)<CR>:pwd<cr>
map <Leader>sk :call SaveSession()<CR>
...
if g:OS#win
    let g:tagbar_ctags_bin = "D:/Downloads/ctags.exe"
elseif g:OS#unix
...
" ************************************************************************************************
let g:fencview_autodetect = 1                         " 0关闭 1开启
...
au BufNewFile,BufRead *.kkf2     setf lua
au BufNewFile,BufRead *.lp       setf lua
